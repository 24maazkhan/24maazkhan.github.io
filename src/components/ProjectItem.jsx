...
const ProjectItem = ({img, title, description}) => {
  return (
    <div className='relative flex items-center justify-center h-auto w-full rounded-xl shadow-xl
     shadow-gray-400 group hover:bg-gradient-to-r from-gray-200 to-[#001b5e]'>
